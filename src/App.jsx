...
class App extends Component {
  ...
  onHandleUpdate = () => {
    axios.put(`https://my-json-server.typicode.com/DwiMunir/crudEa/posts/${this.state.postDataSantri.id}`, this.state.postDataSantri)
      .then(() => {
        this.onGetDataSantri()
        this.setState({
          postDataSantri: {
  ...
  onHandleDelete = (id) => {
    axios.delete(`http://my-json-server.typicode.com/DwiMunir/crudEa/posts/${id}`)
      .then(() => {
        // console.log(res)
        this.onGetDataSantri()
      })
